...
for sweep_id = 1:length(sweep_types)
    ...
    for frequency_id = 1:2
        ...
        for finger_id = 1:3
            ...
            saveas(grid_logPow, strcat(path_save_dir_exp3, filesep, 'mean_power', filesep, 'corr_fundamental_grid_logPower_', file_name_prefix, '.png'));
            close gcf;
            % Log SNR
            ...
            saveas(grid_logSNR, strcat(path_save_dir_exp3, filesep, 'mean_power', filesep, 'corr_fundamental_gird_logSNR_', file_name_prefix, '.png'));
            close gcf;
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %{
            %%% IM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
